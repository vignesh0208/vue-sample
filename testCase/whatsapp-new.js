...
const routes = [
    ...
    {path:"/statusLink/:id", component: statusLink},
    {path:"/newGroup", component:newgroup},
    {path:"/newbroadCast", component:newbroadCast},
    {path:"/starredmessages", component:starredmessages},
    {path:"/settings", component:settings},
    {path:"/settings/account", component:account},
    {path:"/settings/chats", component:settingsChats}
]
                    ...
                    <div class="col-sm-4">
                        <div class="row header">
                            ...
                            <div class="col-sm-4 iconspos" >
                                <router-link to="/search"><i class="fas fa-search" onclick="onDispaly()"></i></router-link>
                            <!--ellipsis dropleft-->
