    ...
    methods: {
        onSelect: function() {
            if (this.state == "Select State") {
                ...
                this.$store.state.optDistrict = this.optState[this.newUser.state].districts
            }
        },
        onAdd: function(){
            this.newUser.state = this.optState[this.newUser.state].state
            if(this.newUser.id == ""){
                alert("Enter Name")
            }
            ...
            else if(this.newUser.state == "Select State"){
                alert("Select State")
            }
            else if(this.newUser.dist == "Select Districts"){
                alert("Select City")
            }
                ...
                this.newUser = { selected: 'Select Blood Group', state: 'Select State', dist: 'Select Districts' }
                                    ...
                                    <div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                <select class="form-control" @change="onSelect()" v-model="newUser.state">
                                                    <option vlaue="Select State">Select State</option>
                                                    <option v-for="(option, index) in optState" v-bind:value="index">{{ option.state }}</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <select class="form-control" v-model="newUser.dist">
                                                    <option vlaue="Select Districts">Select Districts</option>
                                                    <option v-for="option1 in optDistrict" v-bind:value="option1">{{ option1 }}</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-4">
                                            ...
                                            <div class="row row-top">
                                                <div class="col-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8"><input type="text" class="form-control mb-4"  placeholder="City" v-model="user.dist"></div>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="row">
                        ...
                        <div class="card-body">
                            <div class="table-responsive-xl">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr v-for="tel in tells">
                                            <th scope="row">{{tel.company}}</th>
                                            <td>{{tel.jobTitle}}</td>
                                            <td>{{tel.from}}</td>
                                            <td>{{tel.to}}</td>
                                        </tr>
