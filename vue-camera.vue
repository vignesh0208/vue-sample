  ...
  <div class="camera-outer">
    <div class="camera-main" :style="style">
      <div class="camera-control">
        <button class="camera-btn" @click="cameraOn" v-show="!cameraon">æ‰“å¼€æ‘„åƒå¤´</button>
        <button class="camera-btn" @click="cameraOff" v-if="cameraon">å…³é—­æ‘„åƒå¤´</button>
        <button class="camera-btn" @click="toCanvas('video')" v-if="cameraon">ç”ŸæˆCanvas</button>
      </div>
